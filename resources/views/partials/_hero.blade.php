<section class="select-none  relative h-screen bg-[#023047] justify-center flex flex-col align-center text-center">
    ...
    <div class="max-w-7xl container mx-auto hidden lg:block z-10 text-start relative  ">
        ...
        <span
            class="absolute text-[10px] font-semibold text-white bottom-[45px] left-[410px] tracking-widest">PROJECT</span>
