    ...
    <div class="bg-transparent py-16 sm:py-24 lg:py-32">
        <div class="mx-auto flex max-w-7xl justify-between items-center relative">
            ...
            <form class="w-full max-w-md lg:col-span-5 lg:pt-2" method="POST" action="/subscribe">
                ...
                <input id="email" name="email" type="email" autocomplete="email" required class="min-w-0 flex-auto rounded-md border-0 bg-white/10 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-white/75 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6" placeholder="Enter your email" value="{{old('email')}}">
