        ...
        <section class="min-h-screen flex items-stretch text-white ">
            <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center"
                ...
                <div class="w-full px-24 z-10">
                    <h1 class="text-5xl font-bold text-left tracking-wide">Get the latest job!</h1>
            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
                ...
                <div class="w-full py-6 z-20">
                    ...
                    <form action="/users/authenticate" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        @csrf
                        <div class="pb-2 pt-4">
                        ...
                        <div class=" pb-2 pt-6">
                            <button type="submit"
                                class="uppercase block w-full p-4 text-lg rounded-md border border-[#229fe7] hover:bg-[#229fe7] hover:text-black focus:outline-none font-semibold">sign
