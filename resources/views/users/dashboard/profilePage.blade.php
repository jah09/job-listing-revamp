                ...
                <div class="rounded-lg bg-white pb-8 shadow-xl">
                    ...
                    <div class="h-[250px] w-full">
                        <img src="{{ asset('images/s2.jpg') }}"
                            class="h-full w-full rounded-tl-lg rounded-tr-lg object-cover object-center"
                    ...
                    <div class="-mt-20 flex flex-col items-center">
                        ...
                        <div class="mt-2 flex items-center space-x-2">
                            ...
                            <span class="mt-2 rounded-full bg-blue-500 p-1" title="Verified">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-2.5 w-2.5 text-gray-100" fill="none"
                    ...
                    <div class="mt-2 flex flex-1 flex-col items-center justify-end px-8 lg:items-end">
                        <div class="mt-2 flex items-center space-x-4">
                            <a href="/dashboard/settings">
                                <button
                                    class="bg-hipe-dark-blue text-md hover:shadow-hipe-dark-blue-500/40 flex items-center space-x-2 rounded px-4 py-2 font-medium text-white transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-105">
                        ...
                        <div class="flex-1 rounded-lg bg-white p-8 shadow-xl">
                            ...
                            <ul class="mt-2 text-gray-700">
                                <li class="flex border-t py-2">
                                    ...
                                    <span class="text-gray-700">{{ $userDetails->first_name }}
                                        {{ $userDetails->last_name }}</span>
                                </li>

                                <li class="flex py-2">
                                    <span class="w-24 font-bold">Number:</span>
                                ...
                                <li class="flex py-2">
                                    <span class="w-24 font-bold">Age:</span>
                                ...
                                <li class="flex items-center">
                                    <span class="w-24 font-bold">Connect:</span>


                                    <a href="https://www.linkedin.com/in/jeahael-suhot-268314280/" title="LinkedIn"
                                        target="_blank" class="">
                                    ...
                                    <a href="https://github.com/jah09" title="Github" target="_blank" class="ml-2">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="0"
